...
| testEvidenceVerifiedByLatestTestGateEntries | 11 |
...
| --- | --- |
| acceptedPass | True |
| acceptedReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-02-startup-session-navigation\test-build-report.md |
| acceptedPhase | phase-02-startup-session-navigation |
| latestResult | PASS |
| latestReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-02-startup-session-navigation\test-build-report.md |
