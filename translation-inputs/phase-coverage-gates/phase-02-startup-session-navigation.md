...
| testEvidenceVerifiedByLatestTestGateEntries | 39 |
...
| --- | --- |
| acceptedPass | True |
| acceptedReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-04-home-history\test-build-report.md |
| acceptedPhase | phase-04-home-history |
| latestResult | PASS |
| latestReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-04-home-history\test-build-report.md |
