...
| --- | --- |
| acceptedPass | True |
| acceptedReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-05-detail-cart\test-build-report.md |
| acceptedPhase | phase-05-detail-cart |
| latestResult | PASS |
| latestReport | D:\workspace\Foodike\translation-inputs\test-build-reports\phase-05-detail-cart\test-build-report.md |
